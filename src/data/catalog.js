...
export const materials = [
  ...
  {
    slug: 'republic-red-brick',
    name: 'طابوق أحمر جمهوري',
    shortDescription:
      'طابوق أحمر جمهوري يتميز بالصلابة والدقة في التصنيع ومناسب لأعمال البناء والمشاريع الإنشائية.',
    description:
      'طابوق أحمر جمهوري يتميز بالصلابة والدقة في التصنيع، ويعد خيارًا عمليًا لأعمال البناء والمشاريع السكنية والتجارية.',
    image:
      '/republic-red-brick.png',
    specificationGroups: [
      { label: 'القياس', value: '24 × 11.5 × 7.5 سم' },
      { label: 'النوع', value: 'A' },
      { label: 'الوزن', value: '2.3 كيلوغرام' },
      { label: 'قوة الضغط', value: 'MBP 24' },
    ],
    features: ['مقاوم للرطوبة', 'عزل صوت', 'مقاوم للكسر', 'سهل التنفيذ'],
    applications: ['أعمال البناء', 'المشاريع السكنية', 'المشاريع التجارية', 'الجدران والتقسيمات'],
    seo: {
      title: 'طابوق أحمر جمهوري | الخلفاء للتجارة العامة',
      description:
        'اكتشف طابوق أحمر جمهوري من شركة الخلفاء للتجارة العامة، بمواصفات مناسبة لأعمال البناء والمشاريع الإنشائية في العراق.',
      keywords: ['طابوق أحمر جمهوري', 'طابوق أحمر', 'مواد بناء', 'العراق'],
    },
    productSlugs: ['republic-red-brick'],
  },
...
export const products = [
  ...
  },
  {
    slug: 'republic-red-brick',
    name: 'طابوق أحمر جمهوري',
    materialSlug: 'republic-red-brick',
    shortDescription:
      'طابوق أحمر جمهوري يتميز بالصلابة والدقة في التصنيع ومناسب لأعمال البناء، مع مواصفات فنية واضحة تجعله خيارًا عمليًا للمشاريع الإنشائية.',
    description:
      'طابوق أحمر جمهوري يتميز بالصلابة والدقة في التصنيع ومناسب لأعمال البناء، مع مواصفات فنية واضحة تجعله خيارًا عمليًا للمشاريع الإنشائية.',
    image:
      '/republic-red-brick.png',
    ...
    features: ['مقاوم للرطوبة', 'عزل صوت', 'مقاوم للكسر', 'سهل التنفيذ'],
    applications: ['أعمال البناء', 'المشاريع السكنية', 'المشاريع التجارية', 'الجدران والتقسيمات'],
    dimensions: '24 × 11.5 × 7.5 سم',
    weight: '2.3 كيلوغرام',
    usage: 'طابوق أحمر جمهوري',
    seo: {
      title: 'طابوق أحمر جمهوري | الخلفاء للتجارة العامة',
      description:
        'طابوق أحمر جمهوري بمقاس 24 × 11.5 × 7.5 سم، نوع A، وزن 2.3 كيلوغرام وقوة ضغط MBP 24 لمشاريع البناء في العراق.',
      keywords: ['طابوق أحمر جمهوري', 'طابوق أحمر', 'طابوق نوع A', 'مواد بناء العراق'],
    },
  },
]
